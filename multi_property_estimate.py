...
【合計計算・最優先】見積欄に0円以外の数字を表示した費用は、例外なくすべて合計へ加算する。当月前家賃・次月前家賃・敷金・礼金・初回保証料・仲介手数料・火災保険・24時間サポート・鍵交換・事務手数料・図面固有費用・仮計上費用を漏らさない。「－」だけは0円扱いで合計しない。表示した各金額を整数円へ直して足し算し、合計が各表示金額の総和と一致することを回答前に再検算する。
